...
class AuthRepository {
  ...
  /// Account recovery with a code printed by the server-side CLI. Needs no
  /// authentication by design — it has to work while every admin is disabled
  /// or locked out; possession of the code proves access to the server host.
  Future<AuthUserInfo> recover({
  ...
  List<T> _items<T>(Object? data, T Function(Map<String, dynamic>) fromJson) =>
      [
